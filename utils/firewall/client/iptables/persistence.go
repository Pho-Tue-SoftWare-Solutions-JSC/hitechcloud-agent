...
const (
	BasicBeforeFileName = "HiTechCloud_basic_before.rules"
	BasicFileName       = "HiTechCloud_basic.rules"
	BasicAfterFileName  = "HiTechCloud_basic_after.rules"
	InputFileName       = "HiTechCloud_input.rules"
	OutputFileName      = "HiTechCloud_out.rules"
	ForwardFileName     = "HiTechCloud_forward.rules"
	ForwardFileName1    = "HiTechCloud_forward_pre.rules"
	ForwardFileName2    = "HiTechCloud_forward_post.rules"
)
