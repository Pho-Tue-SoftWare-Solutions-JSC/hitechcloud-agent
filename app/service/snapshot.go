...
func (u *SnapshotService) SnapshotImport(req dto.SnapshotImport) error {
	...
	for _, snap := range req.Names {
		...
		shortName = strings.ReplaceAll(shortName, "HiTechCloud-", "")
...
func checkSnapshotIsOk(name string) bool {
	names := []string{"HiTechCloud-core-v2.", "HiTechCloud-agent-v2.", "HiTechCloud-v2.", "snapshot-HiTechCloud-core-v2.", "snapshot-HiTechCloud-agent-v2."}
