...
import (
	...
	csvexport "github.com/Pho-Tue-SoftWare-Solutions-JSC/hitechcloud-agent/utils/csv_export"
	"github.com/Pho-Tue-SoftWare-Solutions-JSC/hitechcloud-agent/utils/encrypt"
	"github.com/Pho-Tue-SoftWare-Solutions-JSC/hitechcloud-agent/utils/geo"
...
func (u *SSHService) ExportLog(ctx *gin.Context, req dto.SearchSSHLog) (string, error) {
	...
	tmpFileName := path.Join(global.Dir.TmpDir, "export/ssh-log", fmt.Sprintf("HiTechCloud-ssh-log-%s.csv", time.Now().Format(constant.DateTimeSlimLayout)))
